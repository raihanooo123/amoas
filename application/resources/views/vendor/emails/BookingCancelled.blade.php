                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <p style="text-align: left;"><strong><span style="font-size:24px">{{ __('emails.greeting') }} {{ $booking->user->first_name }} {{ $booking->user->last_name }}!</span></strong><br>
                                                                    ...
                                                                    @if($refund_status)
                                                                        ...
                                                                        {!! __('emails.invoice_refunded', ['amount' => config('settings.currency_symbol').$booking->invoice->amount
                                                                        , 'payment_method' => $booking->invoice->payment_method ]) !!}

                                                                    @else

                                                                        {!! __('emails.invoice_not_refunded', ['amount' => config('settings.currency_symbol').$booking->invoice->amount]) !!}
