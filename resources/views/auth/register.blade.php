                ...
                <div class="col-12">
                    <div class="wrapper shadow-md radius-lg bg-white">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6 bg-primary-light">
                                <div class="content">
                                    <div class="logo mb-3 p-30">
                                        <a href="index.html" target="_self" title="Teeno"><img
                                                src="{{ asset('/images/logo-dark.png') }}" alt="Logo"></a>
                                    </div>
                                    <div class="svg-image">
                                        <img class="lazyload"
                                            src="{{ asset('frontend/assets/images/banner/placeholder.png') }}"
                                            data-src="{{ asset('frontend/assets/images/banner/login.svg') }}"
                                            alt="Image">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="main-form">
                                    <a href="index.html" class="icon-link" title="Go back to home" target="_self"><i
                                    ...
                                    <form method="POST" action="{{ route('register') }}" class="auth-form" novalidate>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group mb-20">
                                                    <label for="userName"
                                                        class="form-label color-dark">{{ __('app.first_name') }} <span
                                            ...
                                            <div class="col-12">
                                                <div class="form-group mb-20">
                                                    <label for="last_name"
                                                        class="form-label color-dark">{{ __('app.last_name') }}<span
                                                            class="color-red">*</span></label>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-20">
                                                <label for="password3"
                                                    class="form-label color-dark">{{ __('app.phone_number') }} <span
                                                        class="color-red">*</span></label>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-20">
                                                <label for="password3"
                                                    class="form-label color-dark">{{ __('app.email') }} <span
                                                        class="color-red">*</span></label>
                                                <div class="position-relative">
                                                    <input id="email" type="email"
                                                        class="form-control modern-input{{ $errors->has('email') ? ' is-invalid' : '' }}"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-20">
                                                <label for="password3"
                                                    class="form-label color-dark">{{ __('app.password') }} <span
                                                        class="color-red">*</span></label>
                                                <div class="position-relative">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-20">
                                                <label for="confirmPassword"
                                                    class="form-label color-dark">{{ __('app.password_confirmation') }}
                                                    <span class="color-red">*</span></label>
                                                <div class="position-relative">
                                                    <input id="password-confirm" type="password"
                                                        class="form-control modern-input" name="password_confirmation"
                                        ...
                                        <div class="col-12">
                                            <div class="custom-checkbox font-sm">
                                                <input class="input-checkbox" type="checkbox" name="terms"
                                                    id="checkbox4" value="">
                                                <label class="form-check-label" for="checkbox4"><span> I agree with
                                                        Teeno's
                                                        <a href="{{ route('privacy-policy') }}">Terms &
                                ...
                                <div class="text-center mt-20">
                                    <button class="btn btn-lg btn-primary btn-gradient w-100" type="submit"
                                        aria-label="Signup">{{ __('app.register') }}</button>

                                    <div class="link font-sm mt-15">
                                        Already a member? <a href="{{ route('login') }}" target="_self"
