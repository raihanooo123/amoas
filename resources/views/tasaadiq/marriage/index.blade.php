...
<div class="page-title">
    ...
    <div class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ route('marriage.index') }}">Marriage Certificates</a></li>
        </ol>
    </div>
</div>
    ...
    <div id="main-wrapper">
        <div class="row">
            <div class="col-md-12" >
                ...
                <a class="btn btn-primary" href="{{ route('marriage.create') }}"><i
                        ...
                        <div class="table-responsive">
                            <table id="xtreme-table" class="display table" style="width: 100%; cellspacing: 0;">
                                ...
                                <tr>
                                    ...
                                    <th>Serial No</th>
                                    <th>Issue Date</th>
                                    <th>Hus Given Name</th>
                                    <th>Hus Family Name</th>
                                    <th>Hus Passport</th>
                                    <th>Wif Given Name</th>
                                    <th>Wif Family Name</th>
                                    <th>Wif Passport</th>
                                    <th>Registrar</th>
    ...
    $(document).ready(function() {
        ...
        var table = $('#xtreme-table').DataTable({
            ...
            columns: [
                ...
                {
                    data: 'husband_given_name',
                    name: 'husband_given_name'
                },
                {
                    data: 'husband_family_name',
                    name: 'husband_family_name'
                },
                {
                    data: 'husband_passport_no',
                    name: 'husband_passport_no',
                    defaultContent: '-'
                },
                {
                    data: 'wife_given_name',
                    name: 'wife_given_name'
                },
                {
                    data: 'wife_family_name',
                    name: 'wife_family_name'
                },
                {
                    data: 'wife_passport_no',
                    name: 'wife_passport_no',
                    defaultContent: '-'
                },
                {
