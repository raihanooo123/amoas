    ...
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('celibacy.show', $celibacy->id) }}">View {{ $celibacy->serial_no }}</a></li>
            ...
            <div class="col-md-12">
                <div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <div class="col-md-12">
                            <h4 class="panel-title">Edit Celibacy Certificates</h4>
                        </div>
                    </div>
                    <div class="panel-body">
                        <form method="post" action="{{route('celibacy.update', $celibacy->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 form-group {{$errors->has('family_name') ? ' has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="family_name" value="{{ $celibacy->family_name }}">
                            ...
                            <div class="col-md-6 form-group {{$errors->has('given_name') ? ' has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="given_name" value="{{ $celibacy->given_name }}">
                            ...
                            <div class="col-md-6 form-group {{$errors->has('sex') ? ' has-error' : ''}}">
                                ...
                                <select class="form-control" name="sex">
                                    ...
                                    <option value="M" {{ 'M' == $celibacy->sex ? 'selected' : null }}>Male</option>
                                    <option value="F" {{ 'F' == $celibacy->sex ? 'selected' : null }}>Female</option>
                                </select>
                                @if ($errors->has('sex'))
                                    <span class="help-block">
                            ...
                            <div class="col-md-6 form-group {{$errors->has('dob') ? ' has-error' : ''}}">
                                ...
                                <input type="date" class="form-control" name="dob" value="{{ $celibacy->dob }}">
                                @if ($errors->has('dob'))
                                    <span class="help-block">
                            ...
                            <div class="col-md-6 form-group {{$errors->has('pob') ? ' has-error' : ''}}">
                                ...
                                <select class="form-control simple-select2 {{ $errors->has('pob') ? 'is-invalid' : '' }}" name="pob">
                                    ...
                                    <option value="{{$province->label_en}}" {{ $province->label_en == $celibacy->pob ? 'selected' : null }}> 
                            ...
                            <div class="col-md-6 form-group {{$errors->has('passport_no') ? ' has-error' : ''}}">
                                ...
                                <input type="text" class="form-control" name="passport_no" value="{{ $celibacy->passport_no }}">
