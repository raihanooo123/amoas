...
@section('content')
                ...
                <div class="col-lg-6" data-aos="fade-up">
                    <div class="banner-image mb-40 parallax-img" data-speed="0.5" data-revert="true">
                        <img class="lazyload blur-up"
                            data-src="{{ asset('frontend/assets/images/banner/hero-banner-1.png') }}" alt="Banner Image">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            @foreach ($categories as $category)
                                <div class="swiper-slide">
                                    <div class="card p-25 border radius-md text-center">
                                        ...
                                        <span class="font-sm">{{ count($category->packages) }}+ {{ $category->title }}
                                            Available</span>
                                    </div>
                                </div>
                            @endforeach
    ...
    <section class="works-area works-1 pt-100 pb-60 bg-img bg-cover"
        data-bg-image="{{ asset('frontend/assets/images/work-bg-1.png') }} ">
        <div class="container">
            <div class="row align-items-center gx-xl-5">
                <div class="col-lg-5">
                    ...
                    <div class="swiper works-slider mb-40" id="works-slider-1" data-aos="fade-up">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <p class="card-text color-light">
                                    You\'ve successfully booked your appointment! Save or print the confirmation slip for
                                    your visit.
