                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-list" role="menu">
                                    <li role="presentation"><a href="{{ route('customerProfile') }}"><i
                        ...
                        <a href="{{ route('customerProfile') }}">
                            <div class="sidebar-profile-details">
                                <span>Welcome!<br>{{ Auth::user()->first_name }}
                                    {{ Auth::user()->last_name }}<br><small>{{ ucfirst(Auth::user()->role->name) == 'Customer' ? 'Applicant' : ucwords(Auth::user()->role->name) }}</small></span>
                            </div>
                        </a>
                    </div>
                </div>
                <ul class="menu accordion-menu">
                    ...
                    <li>
                        <a href="{{ route('index') }}" class="waves-effect waves-button">
                            ...
                            <p>{{ __('app.new_appointment') }}</p>
                        </a>
                    </li>

                    <li
                        class="{{ Request::is('customer/bookings') || Request::is('customer/booking/*') || Request::is('update-booking/*') ? 'active' : '' }}">
