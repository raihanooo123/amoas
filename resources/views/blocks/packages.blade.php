                        ...
                        <div class="package_title">
                            <div class="text-container">
                                @php
                                    ...
                                    $title .= array_key_exists(1, $titleArr) ? '<h4 class="text-center package_title_large" style="padding-top:0px">' . $titleArr[1] . '</h4>' : '<h3 class="text-center package_title_large">&nbsp;</h3>';
                                @endphp
                                {!! $title !!}
