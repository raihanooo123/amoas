                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="left" style="padding:0;Margin:0;"><p
                                                                    ...
                                                                    <b>Dear {{ $booking->info->full_name }},</b></p>
                                                                @if($user == 'admin')
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;">
                                                                        You have booked an appointment on <u>{{$oldBooking->booking_date . ' ' . $oldBooking->booking_time}}</u>&nbsp;at {{$booking->department->name_en}}.</p>
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;">
                                                                        Due the some reasons and restrictions, we were not able to provide your requested service at the previous appointment date and time.
                                                                    </p>
                                                                @else
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;">
                                                                    You have booked an appointment on <u>{{$oldBooking->booking_date . ' ' . $oldBooking->booking_time}}</u>&nbsp;at {{$booking->department->name_en}}.
                                                                    It seems that your booking's registrar user <u>({{ $user }})</u> has changed your booking on <u>{{$oldBooking->updated_at->diffForHumans()}}</u>.</p>
                                                                @endif
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#FFFFFF;">
                                                                    <span style="background-color:#006699;">Your appointment new date and time has been set to {{$booking->booking_date . ' ' . $booking->booking_time}}.</span>
                                                                </p>
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;">
                                                                    Kindly, consider the new booking date &amp; time,
                                                                    because you are not allowed at our mission in old
                                                                    booking date &amp; time.</p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="left" style="padding:0;Margin:0;"><p
