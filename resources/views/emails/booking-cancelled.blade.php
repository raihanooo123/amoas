                                                            ...
                                                            <td align="left" style="padding:0;Margin:0;">
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;">
                                                                    ...
                                                                    <span style="color:#FFFFFF;">
                                                                        <span style="background-color:#DAA520;">has been cancelled by the registrar user ({{ $user }}) <u>{{$booking->updated_at->diffForHumans()}}</u>.
                                                                        </span>
                                                                    </span>. You are not able to&nbsp;reverse the cancelled appointment, so please book new appointment.<br>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
