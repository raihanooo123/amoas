                                                                                ...
                                                                                <tr style="border-collapse:collapse;">
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <h1
                                                                                            ...
                                                                                            You have successfully submitted Visa Application Form at {{$visaForm->department->name_en}}.</h1>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                                ...
                                                                                <tr style="border-collapse:collapse;">
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            <strong>Dear {{ $name ?? ucwords($visaForm->title) . ' ' . $visaForm->given_name . ' ' . $visaForm->family_name  }}</strong>,</p>
                                                                                        <p
                                                                                            style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;">
                                                                                            You have successfully
                                                                                            submitted Visa Application
                                                                                            Form&nbsp;at <u>{{$visaForm->department->name_en}},</u>
                                                                                            we will check your
                                                                                            application form and send
                                                                                            the approval and rejection
                                                                                            to this email address. Also
                                                                                            you can check your
                                                                                            application status <a href="{{ route('check-status') }}">here</a>.<br>
                                                                                        </p>
                                                                                        <p
                                                                                            style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;">
                                                                                            Your application form serial
                                                                                            number is:</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="border-collapse:collapse;">
                                                                                    <td align="center"
                                                                                        style="padding:0;Margin:0;">
                                                                                        <p
                                                                                            style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:40px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:60px;color:#FFFFFF;">
                                                                                            <b><span
                                                                                                    style="background-color:#CC932B;">{{$visaForm->serial_no}}</span></b>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr style="border-collapse:collapse;">
