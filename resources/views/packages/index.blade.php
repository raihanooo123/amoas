    ...
    <div id="main-wrapper">
        <div class="row">
            <div class="col-md-12">
                ...
                <a class="btn btn-primary btn-lg btn-add" href="{{ route('packages.create') }}"><i
                        class="fa fa-plus"></i>&nbsp;&nbsp;{{ __('backend.add_new_package') }}</a>
                            ...
                            <table id="xtreme-table" class="display table" style="width: 100%; cellspacing: 0;">
                                ...
                                <tbody>
                                    @foreach ($packages as $package)
                                        <tr>
                                            <td>{{ $package->id }}</td>
                                            <td><img src="{{ asset($package->photo->file) }}" width="50"
                                                    height="40"></td>
                                            <td>{{ $package->title }}</td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger btn-xs" data-toggle="modal"
                                                    data-target="#{{ $package->id }}"><i class="fa fa-trash-o"></i></a>
                                                ...
                                                {{-- create a link with pdf icon --}}
                                                <a href="{{ route('packages.pdf', [$package->id]) }}"
