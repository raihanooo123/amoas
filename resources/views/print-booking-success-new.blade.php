    ...
    <div class="container text-black mt-3">
        ...
        <div class="row p-3 mt-4">
            ...
            <div class="col-md-12 text-center mt-4">
                <span
                    style="font-size: 15px; font-weight: bold; border: solid 1.5px #5163af; padding: 10px;">{{ $booking->serial_no }}</span>
            </div>
        </div>
        <div class="row mt-3">
