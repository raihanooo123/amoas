                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center" style="padding:0;Margin:0;"><img
                                                                        class="adapt-img" src="{{ $logo }}" alt
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"
                                                                        height="124"></td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center" class="es-m-txt-c"
                                                                    bgcolor="transparent" style="padding:0;Margin:0;">
                                                                    <h2
                                                                        style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:20px;font-style:normal;font-weight:bold;color:#CC932B;">
                                                                        <strong>Islamic Republic of Afghanistan</strong>
                                                                    </h2>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center" style="padding:0;Margin:0;">
                                                                    <h2
                                                                        style="Margin:0;line-height:20px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:17px;font-style:normal;font-weight:bold;color:#CC932B;">
                                                    ...
                                                    <td width="540" align="center" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center" style="padding:0;Margin:0;">
                                                                    <h2
                                                                        style="Margin:0;line-height:25px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:21px;font-style:normal;font-weight:bold;color:#212121;">
                                                                        <strong>Welcome to AMOAS</strong>
                                                                    </h2>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center" style="padding:0;Margin:0;">
                                                                    <h3
                                                                        style="Margin:0;line-height:25px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:21px;font-style:normal;font-weight:normal;color:#212121;">
                                                                        You have successfully reserved an appointment on
                                                                    </h3>
                                                                    <h3
                                                                        style="Margin:0;line-height:25px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:21px;font-style:normal;font-weight:normal;color:#FFFFFF;background-color:#CC932B;">
                                                                        {{ $booking->booking_date . ' ' . $booking->booking_time }}
                                                                    </h3>
                                                                    <h3
                                                                        style="Margin:0;line-height:25px;mso-line-height-rule:exactly;font-family:tahoma, verdana, segoe, sans-serif;font-size:21px;font-style:normal;font-weight:normal;color:#000000;background-color:#FFFFFF;">
                                                                        at {{ $booking->department->name_en }}.</h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="left" style="padding:0;Margin:0;">
                                                                    <p
                                                                        ...
                                                                        <strong>Dear
                                                                            {{ $name ?? isset($booking->info->full_name) ? $booking->info->full_name : null ?? $booking->user->first_name . ' ' . $booking->user->last_name }}</strong>,
                                                                    </p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#131313;">
                                                                        You have successfully booked an appointment at
                                                                        the <u>{{ $booking->department->name_en }}</u>
                                                                        please be earlier from the time that mentioned
                                                                        above. The following Serial Number is neccessary
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="center" style="padding:0;Margin:0;">
                                                                    <h1
                                                                        ...
                                                                        <b><span
                                                                                style="background-color:#CC932B;">{{ $booking->serial_no }}</span></b>
                                                                    </h1>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <tr style="border-collapse:collapse;">
                                                                    <td align="left" style="padding:0;Margin:0;">
                                                                        <p
                                                                            ...
                                                                            your following relatives. <span
                                                                                style="color:#FFFFFF;background-color:#008080;">Participant/s
                                                                                are not allowed to&nbsp;enter in our
                                                                                mission without you</span>, so please be
                                                            ...
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="left" style="padding:0;Margin:0;">
                                                                    <p
                                                                        ...
                                                                        <u style="font-family: DejaVu Sans, sans-serif;"
                                                                            dir="rtl">{{ $booking->package->title }}</u>,
                                                                        you must
                                                                        provide the following
                                                                        document/s before the appointment date.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse;">
                                                                <td align="left"
                                                                    style="padding:0;Margin:0;font-family: DejaVu Sans, sans-serif;">
