<!--
|--------------------------------------------------------------------------
| ADMIN BOOKING CANCELLATION EMAIL
|--------------------------------------------------------------------------
|
...
<head>
    ...
    <title>{{ __('emails.admin_cancel_subject') }}</title>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                ...
                                                                <p style="text-align: left;"><strong><span style="font-size:24px">{{ __('emails.greeting') }} {{ $user->first_name }} {{ $user->last_name }}!</span></strong><br>
                                                                    <br>
                                                                    {{ __('emails.admin_cancel_text') }}<br>
                                                                    <br>
                                                                    {{ __('emails.admin_notification_login_text') }}</p>
